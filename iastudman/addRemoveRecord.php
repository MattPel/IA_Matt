	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST'){
		...
		if ($conn->connect_error) {
			...
			if ( isset($_POST['removeName'])){
				...
				Student '" . $_POST['removeName'] . "' successfully removed! </p>";		
				else echo "<br> <br> <p style='text-align: center; font-size: 130%; color: #980101; font-weight: bold;'>
				The student '" . $_POST["removeName"] . "' does not exist. Please make sure that the exact inserted name exists. </p>";
			}
			
			else{
				if ( isset($_POST['CourseLevel'])){
					$sql_insert="INSERT INTO `students`(`Name`, `Year`, `SchoolSystem`, `CourseLevel`)
					VALUES ('" . $_POST['name'] . "'," . $_POST['year'] . ",'" . $_POST['SchoolSystem'] . "','" . $_POST['CourseLevel'] . "');";
				} 
				else {
					$sql_insert="INSERT INTO `students`(`Name`, `Year`, `SchoolSystem`) 
					VALUES ('" . $_POST['name'] . "'," . $_POST['year'] . ",'" . $_POST['SchoolSystem'] . "');";	
				}
